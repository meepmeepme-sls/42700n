...
void redShortAutonomous(){
  ...
  intakeGroup.spin(fwd,100,pct);
  drive(1300,1300,90);
  intakeGroup.stop(hold);
  leftDrive.rotateFor(-300,deg,160,rpm);
  drive(-700,-700,70);
  rightDrive.rotateFor(-300,deg,160,rpm);
  intakeGroup.spin(fwd,100,pct);
  drive(900,900,90);
  drive(-1200,-1200,160);
  rightDrive.rotateFor(-200,deg,200,rpm);
  leftDrive.rotateFor(900,deg,200,rpm);
...
int tilterSpeed = 20+100*(1-(tilterMotor.rotation(vex::rotationUnits::deg)/850));
    if(Controller1.ButtonX.pressing()&&(tilterMotor.rotation(vex::rotationUnits::deg)<850)){
