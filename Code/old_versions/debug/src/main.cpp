...
void usercontrol( void ) {
  while (1) {
    Controller1.Screen.print (Controller1.Axis3.value());
    //Drive part.
    int leftDriveSpeed = ((Controller1.Axis3.value()*-1) - Controller1.Axis1.value());
    int rightDriveSpeed = ((Controller1.Axis3.value()*-1)+Controller1.Axis1.value());
    int strafingSpeed = Controller1.Axis4.value();
